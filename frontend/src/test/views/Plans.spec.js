// B0280/B0308 — Plans.vue alert/confirm 反模式消除测试
import { describe, it, expect } from 'vitest'
import { readFileSync } from 'fs'
import { resolve } from 'path'

const SOURCE = readFileSync(resolve(__dirname, '../../views/Plans.vue'), 'utf-8')
...
describe('Plans.vue', () => {
  describe('【B0280/B0308】 移除原生 alert/confirm', () => {
    ...
    it('必须导入 useToast 或 ConfirmDialog 二选一', () => {
      ...
      expect(hasToast || hasConfirm, 'Plans.vue 必须 useToast 或 ConfirmDialog').toBe(true)
    })
  })
})